...
public class CoachContactsActivity {
    private String activity_name,activity_decs;

    public CoachContactsActivity(String activity_name, String activity_desc)
    {
        this.setActivity_name(activity_name);
        this.setActivity_desc(activity_desc);
    }

    public CoachContactsActivity(FragmentActivity activity, int activity_layout) {
    }
